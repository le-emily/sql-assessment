...
select count(brand_id) from models where brand_id = 'for';
...
select * from models where model_id >= 15 and model_id <= 24 order by year;
...
from models as m
where exists (select b.founded
from brands as b where m.year=b.founded);